...
library SqrtPriceMath {
        ...
        returns (uint160)
    {
        ...
        uint256 numerator1 = uint256(liquidity) << FixedPoint96.RESOLUTION; //@audit - Liquidity is converted to uint256 then multiplied by 2^96
        //@audit - we calculate the scaled liquidity : kL = L x 2^96
